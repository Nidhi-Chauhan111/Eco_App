...
class User(Base):
    """PostgreSQL User model for streak tracking"""
    __tablename__ = "users"
...
class UserRepository:
    ...
    def create_user(self, user_id: str, username: str = None) -> User:
        """Create new user"""
        if not username:
    ...
    def update_user_streak(self, user_id: str, new_streak: int, entry_date: date) -> User:
